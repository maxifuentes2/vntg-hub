...
function FloatingHomeButton() {
  ...
  return (
    <Link
      to="/"
      className="fixed top-[125px] md:top-24 left-4 z-[60] bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 px-4 py-2 rounded-2xl flex items-center gap-2 transition-all duration-500 hover:scale-105 active:scale-95 group shadow-lg max-[360px]:px-2 max-[360px]:py-1.5 max-[360px]:top-auto max-[360px]:bottom-4 max-[360px]:left-4"
    >
