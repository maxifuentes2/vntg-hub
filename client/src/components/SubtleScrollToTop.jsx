...
export default function SubtleScrollToTop() {
    ...
    return (
        <button
            onClick={scrollToTop}
            className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[80] bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700  px-4 py-2 sm:px-6 rounded-2xl flex items-center gap-2 transition-all duration-500 hover:scale-105 active:scale-95 group shadow-lg"
        >
