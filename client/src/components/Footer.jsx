                ...
                <div className="col-span-1 md:col-span-2">
                    ...
                    <div className="flex gap-4 mt-8">
                        ...
                        <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="bg-white/40 dark:bg-white/5 backdrop-blur-md p-3 hover:bg-green-500 hover:text-white transition-all text-zinc-600 dark:text-zinc-300 rounded-xl flex items-center justify-center border border-white/20 dark:border-white/5 shadow-sm"
                        >
