            ...
            <div className="max-w-[1400px] mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-20">
                <div className="space-y-12 flex flex-col justify-center">
                    ...
                    <div className="space-y-8 pt-8 border-t border-zinc-200 dark:border-white/10">
                        ...
                        <div className="flex items-center gap-6 group">
                            <div className="bg-white/40 dark:bg-white/5 backdrop-blur-md p-5 border border-white/20 dark:border-white/5 group-hover:border-green-500 transition-colors rounded-xl shadow-lg">
