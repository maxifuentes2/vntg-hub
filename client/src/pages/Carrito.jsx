...
export default function Carrito() {
    ...
    return (
        <div className="w-full transition-colors duration-300">
            ...
            <div 
                className="relative w-full min-h-screen bg-cover bg-center bg-fixed py-12 px-4"
            ...
            >
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    ...
                    {cart.length > 0 ? (
                        ...
                        /* ESTADO VACÍO */
                        <div className="text-center py-20 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm rounded-3xl shadow-sm border border-dashed border-gray-200 dark:border-neutral-800">
