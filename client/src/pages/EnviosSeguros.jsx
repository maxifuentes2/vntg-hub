    ...
    return (
        <div className="bg-white dark:bg-brand-dark min-h-screen text-zinc-900 dark:text-white font-sans transition-colors duration-300">
            ...
            <div className="max-w-[1200px] mx-auto px-6 py-20">
                <div className="bg-zinc-50 dark:bg-[#111111] p-5 sm:p-10 md:p-16 shadow-2xl space-y-12 rounded-3xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white dark:bg-brand-card p-5 sm:p-8 group hover:border-brand-orange rounded-2xl shadow-sm hover:shadow-md transition-all flex flex-col items-start">
                        ...
                        <div className="bg-white dark:bg-brand-card p-5 sm:p-8 group hover:border-brand-blue rounded-2xl shadow-sm hover:shadow-md transition-all flex flex-col items-start">
                            ...
                            <ul className="text-zinc-600 dark:text-zinc-400 font-medium text-sm space-y-3 w-full">
                                <li className="flex justify-between border-b border-zinc-100 dark:border-zinc-800 pb-2"><span className="font-black italic text-zinc-900 dark:text-white">Estándar</span> 3-5 días hábiles</li>
                                <li className="flex justify-between border-b border-zinc-100 dark:border-zinc-800 pb-2"><span className="font-black italic text-zinc-900 dark:text-white">Express</span> 24-48 hs</li>
                        ...
                        <div className="bg-white dark:bg-brand-card p-5 sm:p-8 group hover:border-green-500 rounded-2xl shadow-sm hover:shadow-md transition-all flex flex-col items-start">
