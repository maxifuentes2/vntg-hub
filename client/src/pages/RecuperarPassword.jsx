            ...
            <div className="max-w-md w-full bg-zinc-50 dark:bg-[#111111] border border-zinc-200 dark:border-white/5 p-6 sm:p-12 text-center shadow-2xl relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <input 
                        ...
                        className="w-full bg-white dark:bg-brand-card text-zinc-900 dark:text-white border border-zinc-200 dark:border-white/5 p-4 font-bold italic placeholder:uppercase focus:border-brand-orange outline-none" 
                    />
